...
Page({
  ...
  submitOrder() {
    ...
    wx.showModal({
      ...
      success: (res) => {
        if (res.confirm) {
          wx.navigateTo({
            url: `/subpackages/store/pages/order-detail/index?id=${order.id}`
          });
          return;
        }
  ...
  goProductConfig() {
    wx.navigateTo({
      url: '/subpackages/store/pages/product-config/index'
    });
  },

  goDispatchBoard() {
    wx.navigateTo({
      url: '/subpackages/store/pages/dispatch-board/index'
    });
  },

  goSalesPerformance() {
    wx.navigateTo({
      url: '/subpackages/store/pages/sales-performance/index'
    });
  },
